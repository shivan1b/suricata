...
#[no_mangle]
pub extern "C" fn rs_krb5_probing_parser(_flow: *const Flow, input:*const u8, input_len: u32) -> AppProto {
...
#[no_mangle]
pub extern "C" fn rs_krb5_probing_parser_tcp(_flow: *const Flow, input:*const u8, input_len: u32) -> AppProto {
    let slice = build_slice!(input,input_len as usize);
